...
struct ImageMoveAndScaleSheet: View {
    ...
    @State var pickerType: UIImagePickerController.SourceType?
    ...
    var body: some View {
        ...
        ZStack {
            ZStack {
                ...
                if imageAttributes.originalImage != nil {
                    Image(uiImage: imageAttributes.originalImage!)
                        .resizable()
            ...
            .padding(.bottom, (orientation.orientation == .portrait) ? 30 : 4)
        }
        ...
        .sheet(isPresented: $isShowingImagePicker, onDismiss: loadImage) {
            ...
            SystemPHPicker(image: self.$imageAttributes.originalImage)
...
//            SystemUIImagePicker(image: self.$inputImage, pickerType: self.$pickerType)
//                .accentColor(Color.systemRed)
        }
    ...
    private var openCameraPicker: some View {
        ZStack {
            Image(systemName: "circle.fill")
                .font(.custom("system", size: 45))
                .opacity(0.9)
    ...
    private var saveButton: some View {
        ...
        { Text( viewModel.usePhoto) }
            .opacity((imageAttributes.originalImage != nil) ? 1.0 : 0.2)
            .disabled((imageAttributes.originalImage != nil) ? false: true)
    }
}

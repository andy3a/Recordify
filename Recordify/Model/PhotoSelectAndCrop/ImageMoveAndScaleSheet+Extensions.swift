...
extension ImageMoveAndScaleSheet {
    ...
    func loadImage() {
        guard let inputImage = imageAttributes.originalImage else { return }
    ...
    func setCurrentImage() {
        ...
        imageAttributes.originalImage = currentImage
        inputImageAspectRatio = w / h
    ...
    func composeImageAttributes() {
        ...
        let scale = (imageAttributes.originalImage?.size.width)! / displayW
...
//        //imageAttributes.originalImage = inpu
//
